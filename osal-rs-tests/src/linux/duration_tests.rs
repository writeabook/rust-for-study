...
mod tests {
    ...
    #[test]
    fn test_to_ticks() { test_duration_to_ticks().unwrap(); }

    #[test]
    fn test_from_ticks() { test_duration_from_ticks().unwrap(); }

    #[test]
    fn test_conversion_roundtrip() { test_duration_conversion_roundtrip().unwrap(); }

    #[test]
    fn test_zero() { test_duration_zero().unwrap(); }

    #[test]
    fn test_one_second() { test_duration_one_second().unwrap(); }

    #[test]
    fn test_microseconds() { test_duration_microseconds().unwrap(); }

    #[test]
    fn test_large_value() { test_duration_large_value().unwrap(); }
}
